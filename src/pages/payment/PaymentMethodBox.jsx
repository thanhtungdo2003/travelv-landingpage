...
const PaymentMethodBox = ({ onPaymentChange }) => {
    ...
    return (
        <div className="radio-container">
            <span className="radio-title">Payment method</span>
            ...
            <label className="radio-label">
                <div className="radio-icon-wrapper">
                    <svg fill="currentColor" viewBox="0 0 32 32" height={32} width={32}>
            ...
            {/* Apple Pay, Paypal, Credit Card tương tự, chỉ đổi SVG và text */}
        </div>
    );
};
